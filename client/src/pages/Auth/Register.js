        ...
        <Layout title={"Register - Ecommerce App"}>
            <div className="form-container" style={{ margin: '45px' }}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='mb-3'><input type='text' value={address} onChange={(e) => setAddress(e.target.value)} className="form-control" id="exampleInputAddress" placeholder='Enter Your Address' required /></div>
                    <div className='mb-3'><input type='text' value={answer} onChange={(e) => setAnswer(e.target.value)} className="form-control" id="exampleInputAnswer" placeholder='Who is your favourite Sahabi' required /></div>
